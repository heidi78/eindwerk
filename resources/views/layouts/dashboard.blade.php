...
<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
    ...
    <ul class="sidebar navbar-nav webshop">
      ...
      <li class="nav-item">
        <a href="{{url('#')}}" class="nav-link"><i class="fa fa-exclamation-circle"></i>Categories</a>
                        <ul class="nav nav-second-level">
                            <li>
      ...
      <li class="nav-item">
        <a href="{{url('#')}}" class="nav-link"><i class="fa fa-exclamation-circle"></i>Products</a>
                        <ul class="nav nav-second-level">
                            <li>
      ...
      <li class="nav-item">
        <a href="{{url('#')}}" class="nav-link"><i class="fa fa-exclamation-circle"></i>Roles</a>
                        <ul class="nav nav-second-level">
                            <li>
      ...
      <li class="nav-item">
        <a href="{{url('#')}}" class="nav-link"><i class="fa fa-exclamation-circle"></i>Slider</a>
                        <ul class="nav nav-second-level">
                            <li>
      ...
      <footer class="sticky-footer copy">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © Heidi Vanhoutte</span>
          </div>
        </div>
      </footer>
  @yield('content')
